class DescriptionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @description.save
        format.html { redirect_to description_url(@description), notice: "Description was successfully created." }
  ...
  def update
    respond_to do |format|
      if @description.update(description_params)
        format.html { redirect_to description_url(@description), notice: "Description was successfully updated." }
  ...
  private
    ...
    def description_params
      params.require(:description).permit(:username)
    end
end
